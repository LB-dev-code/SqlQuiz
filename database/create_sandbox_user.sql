...
CREATE USER IF NOT EXISTS 'quiz_sandbox_admin'@'localhost' IDENTIFIED BY 'quiz_sb_admin_2024';
...
CREATE USER IF NOT EXISTS 'quiz_sandbox_user'@'localhost' IDENTIFIED BY 'quiz_sb_user_2024';
